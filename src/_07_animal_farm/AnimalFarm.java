...
for (int i = 0; i < 10; i++) {
		...
		String stuff = JOptionPane.showInputDialog("What animal do you want? (Choose between a cow, duck, dog, cat or a llama!)");
if (stuff.equals("cow")) {
			playMoo();
}

else 
	if (stuff.equals("duck")) {
		playQuack();
}
	else
if (stuff.equals("dog")) {
